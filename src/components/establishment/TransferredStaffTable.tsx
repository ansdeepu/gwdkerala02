        ...
        <Table>
          ...
          <TableBody>
            {paginatedStaff.length > 0 ? paginatedStaff.map((staff, index) => {
              ...
              // Resilient target office detection
              const targetOffice = (staff as any).targetOffice || staff.officeLocation;
              const currentOffice = (staff as any).officeLocationFromPath;
              const isActualDestination = targetOffice && targetOffice.toLowerCase() !== currentOffice?.toLowerCase();
              const displayOffice = isActualDestination ? targetOffice : (staff as any).targetOffice;
              ...
              <TableRow key={staff.id}>
                ...
                <TableCell className="px-2 py-2 text-left font-semibold text-primary">
                    {displayOffice ? formatOfficeName(displayOffice) : "N/A"}
                </TableCell>
