...
const reportableFields = [
    ...
    { id: 'drillingConditions', label: 'Drilling Conditions', sources: ['deposit', 'private', 'collector', 'planFund'], accessor: (entry: any) => entry.drillingConditions },
    { id: 'developingConditions', label: 'Developing Conditions', sources: ['deposit', 'private', 'collector', 'planFund'], accessor: (entry: any) => entry.developingConditions },
    { id: 'schemeConditions', label: 'Scheme Conditions', sources: ['deposit', 'private', 'collector', 'planFund'], accessor: (entry: any) => entry.schemeConditions },
