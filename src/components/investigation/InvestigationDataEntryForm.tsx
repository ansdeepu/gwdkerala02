...
import { Loader2, Trash2, PlusCircle, X, Save, Clock, Eye, ArrowUpDown, Copy, Info, ChevronLeft, ChevronRight, Edit, Move, Printer, FileText, Layers, CheckCircle2, ClipboardList, Receipt, RefreshCw, MapPin, CreditCard, BarChart3 } from "lucide-react";
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Abstract of sites, financial reconciliation, and final status</p>
                    </div>
                  </div>
                </CardHeader>
