...
export default function SelectionNoticePrintPage() {
    ...
    return (
        <div className="-m-6 bg-white min-h-screen print:min-h-0 print:bg-white print:m-0">
          ...
          `}} />
          <div className="max-w-4xl mx-auto p-12 print:p-0 space-y-4 print:space-y-2.5 font-serif text-base print:text-[11pt] print:leading-normal">
              ...
              <div className="pt-2 print:pt-1">
                  ...
                  <div className="ml-8 whitespace-pre-wrap min-h-[6rem] print:min-h-0">
                      <p className="text-lg print:text-base font-semibold">{l1Bidder?.name || '____________________'}</p>
                      <p className="text-lg print:text-base">{l1Bidder?.address || '____________________'}</p>
                  </div>
              </div>
