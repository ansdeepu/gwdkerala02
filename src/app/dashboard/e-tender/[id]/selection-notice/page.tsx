...
export default function SelectionNoticePrintPage() {
    ...
    return (
        <div className="-m-6 bg-white min-h-screen print:min-h-0 print:bg-transparent print:m-0">
            ...
            `}} />
            <div className="max-w-4xl mx-auto p-12 print:p-0 space-y-4 print:space-y-3 font-serif text-base print:text-[11pt] print:leading-relaxed">
                ...
                <div className="pt-6 print:pt-2">
                    <p>പ്രേഷകൻ</p>
                    <p className="ml-8">ജില്ലា ആഫീസർ</p>
                </div>

                <div className="pt-2 print:pt-1">
                    <p>സ്വീകർത്താവ്</p>
                    <div className="ml-8 whitespace-pre-wrap min-h-[6rem] print:min-h-0">
                        <p className="text-lg print:text-[11pt] font-semibold">{l1Bidder?.name || '____________________'}</p>
                        <p className="text-lg print:text-[11pt]">{l1Bidder?.address || '____________________'}</p>
                    </div>
                </div>
