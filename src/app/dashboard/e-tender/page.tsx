...
export default function ETenderListPage() {
    ...
    const confirmCopy = async () => {
        ...
        try {
            const newTenderId = await addTender({
                ...
                fileNo2: tenderToCopy.fileNo2,
                fileNo3: tenderToCopy.fileNo3,
                fileNo4: tenderToCopy.fileNo4,
                ...
                detailedEstimateUrl: tenderToCopy.detailedEstimateUrl,
                tenderFeeDescription: tenderToCopy.tenderFeeDescription,
                emdDescription: tenderToCopy.emdDescription,
                officeLocation: tenderToCopy.officeLocation,
                
                // Reset status and sub-collections
    ...
    const dashboardStats = [
      ...
      { type: 'pendingWorkOrder', label: 'Pending Work/Supply Order', data: categorizedTendersForStats.pendingWorkOrder, colorClass: 'border-emerald-500/50 bg-emerald-500/5', icon: Hammer, tooltip: "Selection notice issued, but final work/supply order is pending." },
    ];
             ...
             <Dialog open={!!dialogContent} onOpenChange={() => setDialogContent(null)}>
              <DialogContent onPointerDownOutside={(e) => e.preventDefault()} className="max-w-2xl h-[80vh] flex flex-col p-0">
                {(() => {
                  ...
                  const showContractorColumn = ["Pending Selection Notice", "Pending Work/Supply Order"].includes(dialogContent?.title || "");
                  const showValidityColumn = dialogContent?.title === "Pending Work/Supply Order";
                      ...
                      <DialogHeader className="p-6 pb-4 pr-12 border-b">
                        ...
                        <DialogDescription asChild>
                          <div className="flex flex-wrap items-center justify-between gap-2 mt-3 text-sm text-muted-foreground font-sans">
                            ...
                            {dialogContent?.title === "Pending Work/Supply Order" && (
